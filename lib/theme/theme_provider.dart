...
class ThemeProvider with ChangeNotifier {
  ...
  TextTheme _customTextTheme(Brightness brightness) {
    final baseColor = brightness == Brightness.dark ? darkTextBase : lightTextBase;
    ...
    return GoogleFonts.playfairDisplayTextTheme().copyWith(
      ...
      titleLarge: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: baseColor),
      titleMedium: TextStyle(fontSize: 20, fontWeight: FontWeight.w600, color: baseColor.withOpacity(0.9)),
      titleSmall: TextStyle(fontSize: 18, fontWeight: FontWeight.w500, color: baseColor.withOpacity(0.85)),
      bodyLarge: GoogleFonts.lato(fontSize: 16, color: baseColor.withOpacity(0.95)),
      bodyMedium: GoogleFonts.lato(fontSize: 14, color: baseColor.withOpacity(0.85)),
      bodySmall: GoogleFonts.lato(fontSize: 12, color: baseColor.withOpacity(0.7)),
      labelSmall: GoogleFonts.lato(fontSize: 12, fontWeight: FontWeight.bold, color: goldenAccent),
    );
  }
